        ...
        <div className="px-3 py-5 border-b border-[#5C6B81]">
            ...
            <span className="relative flex h-12 w-12 shrink-0 overflow-hidden rounded-full">
              ...
              />
                        ...
                        {/* if user online */}
                        <span
                            className="inline-flex rounded-full h-2 w-2 p-0 ring-1 ring-border ring-green-500 items-center justify-center absolute left-[calc(100%-8px)] top-[calc(100%-10px)] bg-green-500"/>
